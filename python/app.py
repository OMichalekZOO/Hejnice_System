...
def site_login_ui():
    ...
    site = st.radio("Lokalita", list(SITES.keys()), key="site_picker")
    if st.button("Pokračovat", key="site_continue"):
        # ZACHOVEJ roli a případně další stavy.
...
def sidebar_site_badge():
    ...
    if site:
        ...
        if role == "admin":
            ...
            st.sidebar.info("Role: **Veřejnost**")
